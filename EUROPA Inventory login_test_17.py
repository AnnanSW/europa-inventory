...
def crew_wide_stats_page():
    ...
    # --- Crew-wide stock display (read-only) ---
    # (No data shown here — access via Dashboard button only)
    st.info("Crew-wide statistics are available through the Dashboard and Consumption History pages.", icon="ℹ️")
