...
# --- CONFIGURATION ---
LOW_STOCK_THRESHOLD = 15 # Adjusted threshold for larger inventory
WARNING_STOCK_THRESHOLD = 30 # Adjusted threshold for larger inventory

# --- BARCODE MAPPING ---
# A dictionary to map a simulated, authentic-looking barcode to the item name and NEW category
BARCODE_MAP = {
    "931301018901": ("Rehydratable Meals", "Beef Stroganoff (Pouch)"),
    "931301018902": ("Rehydratable Meals", "Scrambled Eggs (Powder)"),
    "931301018903": ("Rehydratable Meals", "Cream of Mushroom Soup (Mix)"),
    "931301018904": ("Rehydratable Meals", "Macaroni and Cheese (Dry)"),
    "931301018905": ("Rehydratable Meals", "Asparagus Tips (Dried)"),
    "931301018906": ("Beverage Mixes & Desserts", "Grape Drink (Mix)"), # Moved to new category
    "931301018907": ("Beverage Mixes & Desserts", "Coffee (Mix)"), # Moved to new category
    "931301018908": ("Rehydratable Meals", "Chili (Dried)"),
    "931301018909": ("Rehydratable Meals", "Chicken and Rice (Dried)"),
    "931301018910": ("Rehydratable Meals", "Oatmeal with Applesauce (Dry)"),
    ...
    "931301018916": ("Beverage Mixes & Desserts", "Brownie (Pouch)"), # Moved to new category
    "931301018917": ("Beverage Mixes & Desserts", "Raspberry Yogurt (Pouch)"), # Moved to new category
    "931301018918": ("Thermostabilized Meals", "Ham Steak (Pouch)"),
    "931301018919": ("Thermostabilized Meals", "Sausage Patty (Pouch)"),
    "931301018920": ("Beverage Mixes & Desserts", "Fruit Cocktail (Pouch)"), # Moved to new category

    "931301018921": ("Snacks (Intermediate & Natural)", "Pecans (Irradiated)"),
    "931301018922": ("Snacks (Intermediate & Natural)", "Shortbread Cookies"),
    "931301018923": ("Snacks (Intermediate & Natural)", "Crackers"),
    "931301018924": ("Snacks (Intermediate & Natural)", "M&Ms (Candy)"),
    "931301018925": ("Snacks (Intermediate & Natural)", "Tortillas (Packages)"),
    "931301018926": ("Snacks (Intermediate & Natural)", "Dried Apricots"),
    "931301018927": ("Snacks (Intermediate & Natural)", "Dry Roasted Peanuts"),
    "931301018928": ("Snacks (Intermediate & Natural)", "Beef Jerky (Strips)"),
    "931301018929": ("Snacks (Intermediate & Natural)", "Fruit Bar"),
    "931301018930": ("Snacks (Intermediate & Natural)", "Cheese Spread (Tube)"),

    "931301018931": ("Beverage Mixes & Desserts", "Space Ice Cream (Freeze-dried)"),
    "931301018932": ("Beverage Mixes & Desserts", "Banana Pudding (Pouch)"),
    "931301018933": ("Beverage Mixes & Desserts", "Chocolate Pudding (Pouch)"),
    "931301018934": ("Beverage Mixes & Desserts", "Apple Sauce (Pouch)"),
    "931301018935": ("Beverage Mixes & Desserts", "Orange Juice (Carton)"),
    "931301018936": ("Beverage Mixes & Desserts", "Tea Bags (Box)"),
    "931301018937": ("Beverage Mixes & Desserts", "Hot Cocoa (Mix)"),
    "931301018938": ("Beverage Mixes & Desserts", "Cranberry Sauce (Pouch)"),
    "931301018939": ("Beverage Mixes & Desserts", "Strawberry Shake (Mix)"),
    "931301018940": ("Beverage Mixes & Desserts", "Dried Peaches"),
...
# --- INITIAL INVENTORY (FULLY STOCKED - MATCHING 300-DAY MISSION NEEDS) ---
def get_initial_inventory():
    # Inventory adjusted to meet the 9-month (300-day) mission requirement for 4 crew members,
    # totaling over 9,700 units across all categories.
    return {
        "Rehydratable Meals": { # Target Total: ~1800 units
            "Beef Stroganoff (Pouch)": {"current": 150, "original": 150},
            "Scrambled Eggs (Powder)": {"current": 250, "original": 250},
            "Cream of Mushroom Soup (Mix)": {"current": 180, "original": 180},
            "Macaroni and Cheese (Dry)": {"current": 130, "original": 130},
            "Asparagus Tips (Dried)": {"current": 80, "original": 80},
            "Chili (Dried)": {"current": 120, "original": 120},
            "Chicken and Rice (Dried)": {"current": 160, "original": 160},
            "Oatmeal with Applesauce (Dry)": {"current": 100, "original": 100},
            # Added items to reach target total
            "Vegetable Medley (Dried)": {"current": 250, "original": 250},
            "Tuna Salad (Dry Mix)": {"current": 180, "original": 180}
        },
        "Thermostabilized Meals": { # Target Total: ~1080 units
            "Lemon Pepper Tuna (Pouch)": {"current": 150, "original": 150},
            "Spicy Green Beans (Pouch)": {"current": 120, "original": 120},
            "Pork Chop (Pouch)": {"current": 100, "original": 100},
            "Chicken Tacos (Pouch)": {"current": 140, "original": 140},
            "Turkey (Pouch)": {"current": 90, "original": 90},
            "Ham Steak (Pouch)": {"current": 80, "original": 80},
            "Sausage Patty (Pouch)": {"current": 60, "original": 60},
            # Added items to reach target total
            "Meatballs (Pouch)": {"current": 100, "original": 100},
            "Spaghetti (Pouch)": {"current": 140, "original": 140},
            "Potatoes au Gratin (Pouch)": {"current": 100, "original": 100} 
        },
        "Snacks (Intermediate & Natural)": { # Target Total: ~960 units
            "Pecans (Irradiated)": {"current": 100, "original": 100},
            "Shortbread Cookies": {"current": 140, "original": 140},
            "Crackers": {"current": 160, "original": 160},
            "M&Ms (Candy)": {"current": 150, "original": 150},
            "Tortillas (Packages)": {"current": 140, "original": 140},
            "Dried Apricots": {"current": 80, "original": 80},
            "Dry Roasted Peanuts": {"current": 70, "original": 70}, 
            "Beef Jerky (Strips)": {"current": 50, "original": 50},
            "Fruit Bar": {"current": 60, "original": 60},
            "Cheese Spread (Tube)": {"current": 10, "original": 10} # Reduced one item for initial simulation impact
        },
        "Beverage Mixes & Desserts": { # Target Total: ~3600 units
            "Grape Drink (Mix)": {"current": 300, "original": 300},
            "Coffee (Mix)": {"current": 350, "original": 350},
            "Brownie (Pouch)": {"current": 400, "original": 400},
            "Raspberry Yogurt (Pouch)": {"current": 450, "original": 450},
            "Fruit Cocktail (Pouch)": {"current": 500, "original": 500},
            "Space Ice Cream (Freeze-dried)": {"current": 550, "original": 550},
            "Banana Pudding (Pouch)": {"current": 300, "original": 300},
            "Chocolate Pudding (Pouch)": {"current": 250, "original": 250},
            "Apple Sauce (Pouch)": {"current": 350, "original": 350},
            "Orange Juice (Carton)": {"current": 150, "original": 150} 
        },
        "Condiments & Spreads": { # Target Total: ~2320 units
...
ICON_MAP = {
    ...
    "Snacks (Intermediate & Natural)": "📦",
    "Beverage Mixes & Desserts": "🍹",
    "Condiments & Spreads": "🧂"
}
...
def process_barcode_scan(barcode):
    ...
    if barcode in BARCODE_MAP:
        ...
        # Check if the item exists in the current inventory state
        if category in st.session_state.inventory and item_name in st.session_state.inventory[category]:
            go_to_edit_item(category, item_name)
            st.rerun()
        else:
            st.session_state.barcode_error = f"ERROR: Item '{item_name}' found in manifest but not in current inventory structure."
            st.rerun()
    else:
...
def inventory_page():
    ...
    st.subheader("Deep-Space Mission Food Supply (4 Crew, 300 Days)")
    ...
    with st.form("barcode_scan_form", clear_on_submit=True):
        scanned_barcode = st.text_input(
            "SCAN BARCODE",
            key="barcode_input",
            help="Scan a product barcode here. Hitting Enter submits the code."
        )
    ...
    # 3. CATEGORY BUTTONS 
    st.subheader("Select Food Category")
    col1, col2, col3, col4, col5 = st.columns(5)
    cols = [col1, col2, col3, col4, col5]
    
    # Ensure categories are displayed in the logical order of the dictionary
    for i, category in enumerate(st.session_state.inventory.keys()):
        ...
        # Use an abbreviated name for the button label if it's too long
        display_name = category.replace(" (Intermediate & Natural)", "").replace(" & Desserts", "")
        button_label = f"{ICON_MAP.get(category, '•')} {display_name}"
        
        with cols[i % 5]: 
            if st.button(button_label, key=f"catbtn_{category}", help=f"View: {category}"):
...
def dashboard_page():
    ...
    # --- Metrics Section ---
    st.markdown("<h3>Key Status Indicators (300-Day Mission)</h3>", unsafe_allow_html=True)
    ...
    col2.metric("Low Stock Items (<=15)", low_stock_count, delta=f"{low_stock_delta} low items", delta_color="off" if low_stock_delta == 0 else "inverse")
    ...
    st.markdown("<h3>Stock Levels by Category (Remaining Units)</h3>", unsafe_allow_html=True)
    ...
    st.markdown("<h3>Overall Units Status</h3>", unsafe_allow_html=True)
