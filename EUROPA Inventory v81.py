...
if "change_log" not in st.session_state:
    ...
    st.session_state.change_log = [{
        "version_id": 1,
        "timestamp": MISSION_START_DATE.strftime("%Y-%m-%d %H:%M:%S"),  # aligns with mission start
        "category": "SYSTEM",
        "item": "INITIAL_LOAD",
        ...
        "state_after_change": copy.deepcopy(initial_inventory)  # <- added for proper restore
    }]
    st.session_state.inventory = copy.deepcopy(initial_inventory)  # make sure current inventory is set
