...
def get_personal_inventory_view(username):
    ...
    # rebuild from scratch (IMPORTANT for restore safety)
    for entry in logs:
        ...
        # if this entry was restored later, we must SKIP it
        # (anything after a restore of this version is invalidated implicitly by state)
        ...
        for crew_member, qty in allocations.items():
            ...
            usage_by_category[cat] = usage_by_category.get(cat, 0) + qty
