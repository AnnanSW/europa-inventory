...
def revert_version(version_id):
    try:
        ...
        # --- RESET STREAMLIT WIDGET CACHE (THIS FIXES YOUR BUG) ---
        for key in ["add_units_input", "remove_units_input"]:
        ...
        # --- FORCE FULL UI REBUILD (VERY IMPORTANT) ---
        st.rerun()
