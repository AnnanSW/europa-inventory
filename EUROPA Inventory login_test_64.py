...
def get_personal_inventory_view(username):
    ...
    for category, items in inventory.items():
        ...
        # equal split per crew member
        per_person_original = category_original_total / CREW_SIZE
        per_person_remaining = category_current_total / CREW_SIZE

        personal_data.append({
            "Category": category,
            "Original": per_person_original,
            "Used": per_person_original - per_person_remaining,
            "Remaining": per_person_remaining
        })

        total_original += per_person_original
        total_remaining += per_person_remaining
