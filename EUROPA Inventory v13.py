...
def get_initial_inventory():
    ...
    base_stock_condiments = 2000 # A high starting number for the total 10 condiments
...
def dashboard_page():
    ...
    for i, category in enumerate(df['Category']):
        ...
        # REVERTED COLUMN RATIOS to allow the text to wrap/elide again if it gets too long,
        # but maintaining the explicit metric display (was 2.2, 1, 1, 1.2)
