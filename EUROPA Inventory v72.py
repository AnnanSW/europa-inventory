...
/* 9. Metrics (Dashboard – NO TEXT TRUNCATION) */
/* 9. Metrics (Dashboard – HARD OVERRIDE, NO ELLIPSIS) */
...
/* 🔥 OVERRIDE ALL TEXT INSIDE METRICS */
div[data-testid="stMetric"] * {
