...
def get_personal_inventory_view(username):
    ...
    for category, items in inventory.items():
        ...
        # derive usage from original vs current
        category_current_total = sum(i["current"] for i in items.values())
        category_used = category_original_total - category_current_total

        category_used_person = category_used / CREW_SIZE
        category_remaining = category_original_person - category_used_person
