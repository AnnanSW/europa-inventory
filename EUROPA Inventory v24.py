...
def dashboard_page():
    ...
    for _, data in df.iterrows():
        ...
        days_per_person = np.floor(days_rem / CREW_SIZE)
        ...
        col_cat, col_units, col_days, col_days_pp, col_status = st.columns([1.6, 1, 1, 1, 1.4])
        ...
        col_days_pp.metric("Days / Crew", f"{int(days_per_person):,}")
