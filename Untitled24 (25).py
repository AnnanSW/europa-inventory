...
h1 {
    ...
    margin-bottom: 0px; /* REMOVED SPACE BELOW TITLE LINE */
}
...
div.stButton > button {
    ...
    border-radius: 0px; 
    padding: 10px 20px;
    margin: 15px 5px 5px 0px; /* Increased top margin for spacing between buttons/line */
...
def get_initial_inventory():
    # ... (Inventory data remains the same)
    return {
        "Hydratable Meals": {
...
# --- HELPER FUNCTIONS (Color and Logging logic remains) ---
