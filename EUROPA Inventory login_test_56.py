...
def revert_version(version_id):
    try:
        ...
        st.session_state._personal_stats_reset = True
...
def get_personal_inventory_view(username):
    ...
    valid_logs = [
        ...
        and (head is None or entry["version_id"] <= head)
    ...
    for category, items in inventory.items():
        ...
        category_current_total = sum(i["current"] for i in items.values())
        used_total = category_original_total - category_current_total
        used = used_total / CREW_SIZE
