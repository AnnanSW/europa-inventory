...
def get_initial_inventory():
    """
    NASA-sized portion modeling with uniform per-item stock:
    - Hydratable / Thermostabilized = 1 meal
    - Natural Form = 0.5 meal
    ...
    # Condiments proportional to total entrees
    total_entrees = sum(
        item["original"]
