...
# --- CUSTOM NASA THEME STYLES (Retained and Consolidated) ---
st.markdown("""
<style>
...
/* 5. Generic Button Base Styling (Fallback/Default Green) */
div.stButton > button {
    background-color: #172A45; 
    color: #64FFDA !important;
...
# --- INITIAL INVENTORY (RESET TO FULL) ---
def get_initial_inventory():
    return {
        ...
        "Thermostabilized Meals": {
            ...
            "Fruit Cocktail (Pouch)": {"current": 75, "original": 75} # Reset to high stock
        },
        "Natural Form & Irradiated": {
            ...
            "Dry Roasted Peanuts": {"current": 70, "original": 70}, # Reset to high stock
